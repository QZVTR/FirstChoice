...
export default function AboutUs() {
  return (
    <>
        ...
        professionalism. We carefully vet each tradesperson in our network, ensuring they possess the
        necessary licenses, insurance, and qualifications. We continuously monitor customer feedback to
        ensure that our professionals consistently meet and exceed expectations.
        Your satisfaction is our priority, and we are here to support you throughout the entire process. Our
        ...
        looking for new opportunities, we are here to connect you.
